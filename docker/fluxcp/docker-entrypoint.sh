...
generate_config() {
    ...
    # Generate application.php configuration
    echo "[FluxCP] Generating application configuration..."
    cat > "${CONFIG_FILE}" << PHPEOF
<?php
// FluxCP Application Configuration
...
PHPEOF
    ...
    # Generate servers.php configuration with database connection
    echo "[FluxCP] Generating server connection configuration..."
    cat > "${SERVERS_FILE}" << PHPEOF
<?php
